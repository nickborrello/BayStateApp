...
from scraper_backend.core.adaptive_retry_strategy import AdaptiveRetryStrategy, FailureContext
from scraper_backend.core.captcha_solver import CaptchaSolver, CaptchaSolverConfig
